...
// ZeroTextsForTest exposes the texts the forbid side names for a Go zero, so
// the scalar tests can pin that a coerced shape forbids every text it
// actually emits.
func (sh Shape) ZeroTextsForTest() ([]any, error) { return sh.zeroTexts() }
