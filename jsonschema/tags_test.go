...
func (p *parentInspector) Interpret(_ context.Context, field jsonschema.FieldContext) error {
	count := 0
	if field.Parent != nil {
...
func (i *structFieldInspector) Interpret(_ context.Context, field jsonschema.FieldContext) error {
