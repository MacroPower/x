...
func TestRefResolverFunc(t *testing.T) {
	...
	require.NoError(t, jsonschema.Validate(schema, "ok", jsonschema.WithResolver(resolver)))

	err := jsonschema.Validate(schema, float64(5), jsonschema.WithResolver(resolver))
...
func TestRefResolverFunc_Error(t *testing.T) {
	...
	err := jsonschema.Validate(schema, "ok", jsonschema.WithResolver(resolver))
