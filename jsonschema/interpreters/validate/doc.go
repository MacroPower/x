...
// checked as a bare part would be, on a scratch copy of the field whose
// canvas and element canvases reach the schema no further, since
// go-playground runs it whenever the alternatives before it fail and panics
// there on a parameter it cannot read.
//
