...
// Prepare resets per-file state.
func (a *Annotator) Prepare(_ []byte) error {
	a.rootSchema = nil
	a.seenFirstKey = false
...
// from a single comment line, consistent with the PRD's comment stripping rule.
